...
public class DataInitializerForQualityControlStandart implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (repository.count() == 0) {
            ...
            repository.save(new QualityControlStandard(2,9, 15, 3, 0, 1, 5, 1, 2, 8, 1, 2, 13, 2, 3));
            repository.save(new QualityControlStandard(3,16, 25, 3, 0, 1, 8, 2, 3, 13, 2, 3, 20, 3, 4));
            repository.save(new QualityControlStandard(4,26, 50, 5, 1, 2, 13, 2, 3, 20, 3, 4, 32, 5, 6));
            repository.save(new QualityControlStandard(5,51, 90, 5, 1, 2, 20, 3, 4, 32, 5, 6, 50, 7, 8));
            repository.save(new QualityControlStandard(6,91, 150, 8, 2, 3, 32, 5, 6, 50, 7, 8, 80, 10, 11));
            repository.save(new QualityControlStandard(7,151, 280, 13, 2, 3, 50, 7, 8, 80, 10, 11, 125, 14, 15));
