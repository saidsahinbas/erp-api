...
public class OrderService {
    ...
    public OrderService(OrderRepository orderRepository, UserService userService, SupplierService supplierService,
                        WarehouseService warehouseService, ProductService productService,
                        OrderLineService orderLineService, PurchaseOrderApprovalService purchaseOrderApprovalService) {
    ...
    public List<Order> getAllOrders() {
        return orderRepository.findAllByOrderStatus(OrderStatus.RECEIVED);
    }
